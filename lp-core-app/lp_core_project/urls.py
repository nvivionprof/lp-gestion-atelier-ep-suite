...
urlpatterns = [
    ...
    path('base-sql/', views.sql_database_admin, name='sql_database_admin'),
    path('base-sql/export.sql', views.sql_database_export, name='sql_database_export'),
    path('base-sql/import/', views.sql_database_import, name='sql_database_import'),
